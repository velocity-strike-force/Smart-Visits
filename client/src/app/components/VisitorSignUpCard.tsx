...
export default function VisitorSignUpCard({
    visit,
    onSignUp,
    isSignedUp,
}: VisitorSignUpCardProps) {
            ...
            <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-lg font-medium text-green-800">
                        You're signed up for this visit!
                    </h3>
                </div>
        ...
        return (
            <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
                ...
                <p className="text-red-700 text-sm">
                    All {visit.capacity} spots have been taken. Check back later
                    for new visits.
                </p>
            </div>
        );
            ...
            <div className="flex items-center justify-between mb-4">
                <div>
                    <h3 className="text-xl font-medium mb-2 text-gray-900">
                        Join this customer visit
                    </h3>
                    <div className="space-y-1 text-sm text-gray-600">
                        <div className="flex items-center gap-2">
                            <Calendar className="w-4 h-4" />
                            <span>
                                {format(visit.date, "EEEE, MMMM dd, yyyy")}
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
