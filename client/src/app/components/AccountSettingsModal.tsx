        ...
        <div className="flex-1 overflow-auto p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              {productLineOptions.map(line => (
                <label key={line} className="flex items-center gap-2 text-sm">
                  <input
                    type="checkbox"
                    checked={settings.productLines.includes(line)}
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center justify-between">
                <span className="text-sm">Slack DM notifications</span>
                <input
                  type="checkbox"
              ...
              <label className="flex items-center justify-between">
                <span className="text-sm">Distance from location alerts</span>
                <input
                  type="checkbox"
                  checked={settings.distanceAlerts}
                  onChange={(e) => setSettings({ ...settings, distanceAlerts: e.target.checked })}
                  className="rounded"
                />
              </label>
            </div>
